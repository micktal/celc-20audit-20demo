...
const collectes = [
  {
    id: "c1",
    name: "Plan d’implantation – Agence A",
    type: "PDF",
    site: "Agence A",
    date: "20/02/2025",
  },
...
const interm = [
  ...
  {
    id: "i2",
    name: "État d’avancement PRISCOP",
    type: "PDF",
    status: "Publié",
    date: "27/02/2025",
  },
  {
    id: "i3",
    name: "Note incidents & signaux faibles",
    type: "PDF",
    status: "En revue",
    date: "28/02/2025",
  },
          ...
          <header className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-[hsl(var(--fiducial-grey))]">
                Repository sécurisé — structuré par source
              </p>
            </div>
            <div className="flex items-center gap-3">
              ...
              <button className="px-3 py-2 rounded-md bg-white border border-border">
                Téléverser
              </button>
            </div>
          </header>
                    ...
                    {filtered.map((d: any) => (
                      ...
                      >
                        ...
                        <td className="py-2 px-3">
                          {(d as any).site || (d as any).version || "-"}
                        </td>
                        <td className="py-2 px-3">{d.date}</td>
                        <td className="py-2 px-3">
                          <button className="text-sm text-[hsl(var(--bg))]">
                            Télécharger
                          </button>
                        </td>
                      </tr>
