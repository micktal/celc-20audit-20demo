    ...
    <div className="min-h-screen bg-[hsl(var(--light-grey))]">
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          ...
          <p className="text-sm text-[hsl(var(--fiducial-grey))]">Visualisation détaillée des incidents, de leur sévérité et de leur répartition dans le temps.</p>

          <div className="mt-6 bg-white p-4 rounded-[20px] shadow-sm border border-border flex flex-wrap items-center gap-3">
            <select value={filters.period} onChange={(e) => filters.setPeriod(e.target.value as any)} className="p-2 border rounded">
            ...
            <select value={filters.agencyId || "Toutes"} onChange={(e) => filters.setAgency(e.target.value === "Toutes" ? null : e.target.value)} className="p-2 border rounded">
            ...
            <select value={filters.criticity} onChange={(e) => filters.setCriticity(e.target.value as any)} className="p-2 border rounded">
            ...
            <select value={filters.typologie} onChange={(e) => filters.setTypologie(e.target.value as any)} className="p-2 border rounded">
              <option value="All">Tous</option>
